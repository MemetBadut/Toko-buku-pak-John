                    ...
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="flex-1 p-6 flex flex-col">
                            ...
                            <div class="flex flex-wrap gap-2 mb-4">
                                <span class="px-4 py-1.5 bg-indigo-600 text-white rounded-full text-sm font-medium"
                                    x-text="book.category"></span>
                                <template x-for="genre in book.genre" :key="genre">
                                    <span class="px-4 py-1.5 bg-gray-200 text-gray-700 rounded-full text-sm"
                                        x-text="genre"></span>
                                </template>
                            </div>
