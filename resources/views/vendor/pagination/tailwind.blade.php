@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:gap-2 sm:items-center sm:justify-between">
            ...
            <div>
                <span class="flex rtl:flex-row-reverse shadow-sm rounded-md items-center gap-4">

                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
                        <span class="text-gray-600 cursor-not-allowed text-sm px-4 py-2">Previous</span>
                    @else
                    ...
                    @else
                        <span class="text-gray-600 text-sm px-4 py-2 cursor-not-allowed">Next</span>
                    @endif
                </span>
            </div>
        </div>
